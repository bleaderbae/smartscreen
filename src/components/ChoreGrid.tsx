...
const ChoreGrid: React.FC = () => {
  ...
  // Optimized: Use useCallback to ensure the toggle handler reference is stable
  // This prevents unnecessary re-renders of all ChoreWidgets when one is toggled
